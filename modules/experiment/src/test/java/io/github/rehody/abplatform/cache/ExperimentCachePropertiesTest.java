...
class ExperimentCachePropertiesTest {
    ...
    void validate_shouldReturnNoViolationsAndAcceptValidProperties() {
        ExperimentCacheProperties properties = validProperties();

        Set<ConstraintViolation<ExperimentCacheProperties>> violations = validator.validate(properties);
    ...
    private ExperimentCacheProperties validProperties() {
        ExperimentCacheProperties properties = new ExperimentCacheProperties();
        ...
        properties.setRedisKeyPrefix("ab-platform:cache:experiment:v1:");
        properties.setInvalidationTopic("ab-platform:cache:experiment:v1:invalidation");
        return properties;
    }
}
